(function(root, factory) {
    ...
    var defaults = {
       ...
       // ITEM_STYLE = 'style="width:100%;height:100%;line-height:{h}px"',
    ...
    Calendar.prototype = {
        ...
        getDayItem: function(y, m, d, f) {
            ...
            data.w = data.w>data.h?data.h:data.w;
            data.h = data.w>data.h?data.h:data.w;
        ...
        event: function() {
            ...
            _this.$element.on('click', '[' + ITEM_DAY + ']', function() {
                ...
                _this.options.onSelected.call(this, 'date', day.format("yyyymmdd"), $(this).data(MARK_DATA));
