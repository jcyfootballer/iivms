...
;(function ($, window, undefined)
{
    ...
    */
                ...
                $.each(that.columns, function (j, column)
                {
                    if (column.visible)
                    {
                        ...
                        cells += tpl.cell.resolve(getParams.call(that, {
                            ...
                            title:	(value == null || value === "" || ($.isFunction(column.formatter))) ? "" : value,
    ...
    /**
     * Resets the state and reloads rows appended by exist_url.
     *
     * @method reloadData
     * @chainable
     **/
    Grid.prototype.reloadData = function(exist_url)
    {
    	this.options.url = exist_url; // reset
        loadData.call(this);
